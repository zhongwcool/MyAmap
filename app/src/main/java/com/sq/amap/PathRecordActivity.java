...
public class PathRecordActivity extends Activity implements LocationSource,
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, PathRecordActivity.class);
...
//		}
    ...
    public void record(View view) {
        Intent intent = new Intent(PathRecordActivity.this, RecordActivity.class);
        ...
        if (lineID == 1) {
            if (linepoints != null && linepoints.size() > 0) {
                ...
                if (mlocMarker == null) {
                    ...
                    Toast.makeText(PathRecordActivity.this, "距离" + mDistance, Toast.LENGTH_SHORT).show();
